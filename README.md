...
从 GitHub Release 或本仓库的 `downloads` 下载 `ZkalanInkDeck-0.5.1-macOS-arm64.zip`，解压后将应用拖到「应用程序」或 `~/Applications`，双击打开。窗口副标题为 `0.5.1 · 按住 E 临时擦除`，原型旧称「触控板手写 2」，新版会读取已有草稿。
...
定位光标和橡皮擦圆圈使用黑白双层轮廓，并在笔迹上方绘制，因此在黑色笔迹、白色画布和桌面背景上都能辨认。
